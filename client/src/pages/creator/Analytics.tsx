          ...
          <Card className="bg-gradient-card border-border/50">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                ...
                <Users className="h-8 w-8 text-white opacity-70" strokeWidth={1} />
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-card border-border/50">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                ...
                <Heart className="h-8 w-8 text-white opacity-70" strokeWidth={1} />
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-card border-border/50">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                ...
                <FileText className="h-8 w-8 text-white opacity-70" strokeWidth={1} />
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-card border-border/50">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                ...
                <DollarSign className="h-8 w-8 text-white opacity-70" strokeWidth={1} />
              </div>
            </CardContent>
          </Card>
        </div>
