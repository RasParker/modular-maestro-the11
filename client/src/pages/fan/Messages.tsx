                    ...
                    >
                      <div className="flex items-center gap-3">
                        <Avatar className="w-12 h-12 flex-shrink-0">
                          <AvatarImage src={conv.creator.avatar} alt={conv.creator.display_name} />
                          <AvatarFallback>
                            {conv.creator.display_name?.charAt(0) || conv.creator.username.charAt(0)}
                          </AvatarFallback>
                        </Avatar>
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between gap-2">
                            <p className="font-medium text-foreground truncate">
                              {conv.creator.display_name || conv.creator.username}
                            </p>
                ...
                <>
                  ...
                  <div className="p-4 border-b border-border/50 flex items-center gap-3">
                    <Avatar className="w-10 h-10">
                      ...
                      <AvatarFallback>
                        {selectedConversation.creator.display_name?.charAt(0) || selectedConversation.creator.username.charAt(0)}
                      </AvatarFallback>
                    </Avatar>
                    <div className="flex-1">
                      <h3 className="font-semibold text-foreground">
                        {selectedConversation.creator.display_name || selectedConversation.creator.username}
                      </h3>
